									...
									<template subtype="element" match="eml:EML">
										<children>
											<template subtype="element" match="eml:Count">
																...
																<children>
																	<template subtype="element" match="eml:ElectionCategory">
																		<children>
																			...
																			<newline/>
																			<newline/>
																			<text fixtext="Dit proces-verbaal heeft betrekking op het referendum over "/>
																		</children>
																		<variables/>
																	</template>
																					...
																					<tgridrow>
																						<children>
																							...
																							<tgridcell>
																								<styles vertical-align="top"/>
																								<children>
																									<text fixtext="bezwaren ingebracht: zie de gewaarmerkte bijlage met opmerkingen van het centraal stembureau."/>
																								</children>
																							</tgridcell>
																						</children>
																					</tgridrow>
												...
												<variables>
													<variable name="includesPostalVotes" value="true()" valuetype="xs:boolean"/>
													<variable name="isElection" value="false()" valuetype="xs:int"/>
												</variables>
											</template>
										</children>
										<variables/>
